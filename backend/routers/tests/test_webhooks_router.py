...
class TestWebhooksRouter:
    ...
    def mock_webhook_signature(self):
        ...
        with patch("services.webhooks.WebhooksService.verify_webhook_signature", return_value=True):
            yield
    ...
    def test_product_update_webhook_with_inventory(self, client, mock_webhook_signature, sample_product_data):
        ...
        assert product_info["title"] == "Big Apple Dodgeball - Tuesday - Open Division - Fall 2025"
    ...
    def test_product_update_webhook_sold_out(self, mock_gas_send, client, mock_webhook_signature, sample_product_data):
    ...
    def test_invalid_signature_returns_401(self, client, sample_product_data):
        ...
        with patch("services.webhooks.WebhooksService.verify_webhook_signature", return_value=False):
            headers = {
                "x-shopify-topic": "products/update",
