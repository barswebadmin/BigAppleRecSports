...
class TestSlackModalHandlers:
    ...
    async def test_show_deny_refund_request_modal_success(self):
        ...
        # Setup
        self.mock_api_client.send_modal.return_value = {"success": True, "view": {"id": "V123"}}
    ...
    async def test_show_deny_refund_request_modal_api_failure(self):
        ...
        # Setup
        self.mock_api_client.send_modal.return_value = {"success": False, "error": "API Error"}
            ...
            "view": {
                "state": {
                    "values": {
                        ...
                        "include_staff_info": {
                            "include_staff_info": {"selected_options": [{"value": "include_staff"}]}
                        }
                    }
                },
    ...
    @pytest.mark.asyncio
    @patch('requests.post')
    async def test_handle_deny_refund_request_modal_submission_no_staff_info(self, mock_post):
            ...
            "view": {
                "state": {
                    "values": {
                        ...
                        "include_staff_info": {
                            "include_staff_info": {"selected_options": []}  # No staff info
                        }
                    }
                },
                "private_metadata": json.dumps({
    ...
    @pytest.mark.asyncio
    @patch('requests.post')
    async def test_handle_deny_refund_request_modal_submission_gas_failure(self, mock_post):
...
class TestModalBlockBuilding:
    ...
    def test_build_deny_request_modal_blocks_delegates_to_utils(self, mock_utils_class):
        ...
        mock_utils_instance._build_deny_request_modal_blocks.return_value = [{"type": "section"}]
    ...
    def test_show_modal_to_user_structure(self):
        ...
        modal_blocks = [{"type": "section", "text": {"type": "plain_text", "text": "Test"}}]
