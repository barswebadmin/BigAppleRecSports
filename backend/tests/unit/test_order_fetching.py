...
class TestOrderFetching:
    ...
    def test_orders_service_fetch_by_order_name_success(self):
        ...
        with patch.object(orders_service.shopify_service, '_make_shopify_request') as mock_request:
            mock_request.return_value = self.mock_shopify_response
            
            result = orders_service.fetch_order_details_by_email_or_order_name(order_name=self.test_order_number)
    ...
    def test_orders_service_fetch_by_order_name_with_hash_prefix(self):
        ...
        with patch.object(orders_service.shopify_service, '_make_shopify_request') as mock_request:
            ...
            result = orders_service.fetch_order_details_by_email_or_order_name(order_name=f"#{self.test_order_number}")
    ...
    def test_orders_service_no_order_found(self):
        ...
        with patch.object(orders_service.shopify_service, '_make_shopify_request') as mock_request:
            ...
            result = orders_service.fetch_order_details_by_email_or_order_name(order_name="nonexistent")
    ...
    @patch('services.orders.orders_service.OrdersService.fetch_order_details_by_email_or_order_name')
