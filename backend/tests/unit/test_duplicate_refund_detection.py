...
class TestDuplicateRefundDetection:
    ...
    def test_check_existing_refunds_with_refunds(self):
        ...
        # Setup mock response
        self.mock_shopify_service._make_shopify_request.return_value = self.sample_shopify_response_with_refunds
        ...
        assert refund["total_refunded"] == "19.0"  # Updated: now calculated from transactions
    ...
    def test_check_existing_refunds_no_refunds(self):
        ...
        # Setup mock response
        self.mock_shopify_service._make_shopify_request.return_value = self.sample_shopify_response_no_refunds
    ...
    def test_check_existing_refunds_malformed_response(self):
        ...
        self.mock_shopify_service._make_shopify_request.return_value = {"data": {"order": None}}
    ...
    def test_build_duplicate_refund_message(self):
        ...
        assert update_button["action_id"] == "edit_request_details"  # Updated: same as email mismatch
    ...
    def test_check_existing_refunds_exception_handling(self, mock_logger):
        ...
        self.mock_shopify_service._make_shopify_request.side_effect = Exception("API Error")
        ...
        assert "Error checking existing refunds for order" in str(mock_logger.error.call_args)
    ...
    def test_check_existing_refunds_with_pending_refund(self):
        ...
        # Setup mock response
        self.mock_shopify_service._make_shopify_request.return_value = sample_pending_response
