...
class Customer(ShopifyBaseModel):
    ...
    def build_query(
        ...
        customers.nodes.note()  # type: ignore[union-attr]
        ...
        last_order = customers.nodes.lastOrder()  # type: ignore[union-attr]
        last_order.id()  # type: ignore[union-attr]
        last_order.createdAt()  # type: ignore[union-attr]
