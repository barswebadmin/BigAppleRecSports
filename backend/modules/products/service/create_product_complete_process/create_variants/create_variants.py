...
def create_variants(
    ...
    try:
        ...
        options_response = shopify_orchestrator._make_shopify_request(options_mutation)
        ...
        first_variant_response = shopify_orchestrator._make_shopify_request(
            first_variant_query
        )
        first_variant_gid = (
        ...
        inventory_response = shopify_orchestrator._make_shopify_request(inventory_query)
        inventory_item_id = (
        ...
        price_response = shopify_orchestrator._make_shopify_request(price_update_mutation)
        ...
        inventory_response = shopify_orchestrator._make_shopify_request(
            inventory_update_mutation
        )
        ...
        if remaining_variants:
            ...
            bulk_response = shopify_orchestrator._make_shopify_request(bulk_create_mutation)
            created_variants = (
