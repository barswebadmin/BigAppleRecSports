...
from modules.products.service.product_parser import get_slack_group_mention, parse_for_waitlist_form
...
# from modules.integrations.google_apps_script.client import GASClient
from modules.orders.service.order_create_webhook_handler import evaluate_order_create_webhook, slack_message_builder
from modules.products.service.product_update_webhook_handler import evaluate_product_update_webhook
from modules.products.service.product_parser import parse_for_waitlist_form
...
class WebhooksOrchestrator:
    ...
    def __init__(self):
        ...
        self.slack = SlackOrchestrator()
        # self.gas_client = GASClient(gas_url)
        self.slack_channel = config.Slack.Channels
        self.slack_bot = config.Slack.Bots
        self.slack_group = config.Slack.Groups
    ...
    def verify_webhook_signature(self, body: bytes, headers: dict) -> bool:
        ...
        return verify_webhook_signature(source="shopify", body=body, headers=headers)
