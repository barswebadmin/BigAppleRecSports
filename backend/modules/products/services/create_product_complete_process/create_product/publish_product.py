...
def publish_product_at_time(
    ...
    try:
        ...
        # Make the request
        response = shopify_service._make_shopify_request(publish_mutation)
...
def publish_product_now(
    product_gid: str, shopify_service: Optional[ShopifyService] = None
) -> Dict[str, Any]:
    """
    ...
    Args:
        ...
        shopify_service: ShopifyService instance (optional)

    Returns:
        Dict with success status and any error details
    """
    return publish_product_at_time(product_gid, datetime.now(), shopify_service)
