...
from .enums import MediaContentType, MediaStatus
from .fragments import ImageContent


class GetMediaImage(BaseModel):
    node: Optional[
        Annotated[
            Union["GetMediaImageNodeNode", "GetMediaImageNodeMediaImage"],
            Field(discriminator="typename__"),
        ]
    ]


class GetMediaImageNodeNode(BaseModel):
    typename__: Literal[
        "AbandonedCheckout",
...
class GetMediaImageNodeMediaImage(BaseModel):
    typename__: Literal["MediaImage"] = Field(alias="__typename")
    id: str
    alt: Optional[str]
    status: MediaStatus
    media_content_type: MediaContentType = Field(alias="mediaContentType")
    image: Optional["GetMediaImageNodeMediaImageImage"]


class GetMediaImageNodeMediaImageImage(ImageContent):
    pass


GetMediaImage.model_rebuild()
GetMediaImageNodeMediaImage.model_rebuild()
