...
class TestRefundCalculator:
    ...
    @patch('services.orders.refund_calculator.extract_season_dates')
    def test_calculate_refund_success(self, mock_extract, mock_calculate, calculator, sample_order_data):
    ...
    @patch('services.orders.refund_calculator.extract_season_dates')
    def test_calculate_refund_extraction_error(self, mock_extract, calculator, sample_order_data):
