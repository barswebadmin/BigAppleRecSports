        ...
        try:
            ...
            return {
                ...
                "confirm": {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": f"Cancel order {order_name} in Shopify? This will show refund options next.",
                    },
        ...
        try:
            ...
            return {
                ...
                "confirm": {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": f"Keep order {order_name} active and proceed to refund options?",
                    },
        ...
        try:
            ...
            return {
                ...
                "confirm": {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": f"This will deny the refund request for {order_name}. The requestor will be notified. Are you sure?",
                    },
