...
def validate_environment():
    ...
    print_check(
        ...
        else "Set ENVIRONMENT=production for live deployment",
    )
    ...
    return (
        env_is_production and has_shopify_token and has_slack_token and has_slack_secret
    )
...
def validate_services():
    ...
    try:
        ...
        print_check("Slack Service", True, f"Initialized with {api_client_type}")
...
def validate_workflow_components():
    ...
    print_check(
        ...
        production_mode,
        "Will make real Shopify API calls"
        if production_mode
        else "Will use mock calls",
    )
