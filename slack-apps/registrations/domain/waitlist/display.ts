/** Waitlist display helpers — pure domain formatting, no Slack API or I/O. */

import type { EmailLookupEntry, WaitlistEntry } from "./types.ts";
import type { ActionResult } from "./action_result.ts";
import { formatDivisionLabel, formatLeagueLabelShort } from "../league/format.ts";
import { capitalize } from "../../shared/text/strings.ts";
import { SLACK_LINK_TEXT, slackLink, tagSlackMember } from "../../config/slack.ts";
