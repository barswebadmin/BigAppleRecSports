...
/**
 * Capitalize the first letter of a string, optionally convert to title case
 * @param {string} str - String to capitalize
 * @param {boolean} toTitleCase - If true, capitalizes each word (title case), defaults to false
 * @returns {string} Capitalized string
 */
function capitalize(str, toTitleCase = false) {
  if (!str) return str;
