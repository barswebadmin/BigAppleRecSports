        ...
        productCreate(
          ...
          product: {
            ...
            descriptionHtml: "
              ...
              <ul>
                ${(vetRegistrationStartDateTime?.raw && vetRegistrationStartDateTime?.formatted && !vetRegistrationStartDateTime.formatted.includes('Invalid Date')) ? `
                  <li>
                    <p>
                      <span><b>Vet Registration:</b> ${vetRegistrationStartDateTime.formatted}
