...
function  processFormSubmit(e) {
  try {
    ...
    // Fire-and-log call to the new ShopifyRefundHandler lambda. No-ops with a
    // log warning when LAMBDA_REFUND_HANDLER_URL Script Property is unset, and
    // never throws — see src/lambdaWebhook.js. Runs in addition to the legacy
    // backend call above so we can compare the two during rollout.
    postRefundRequestToLambda(
