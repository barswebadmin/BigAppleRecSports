...
/**
 * Normalize a raw order number to Shopify's display-name form ("#1234").
 *
 * Form submitters enter just the digits per the form instructions; downstream
 * helpers (sheet row lookup, Slack admin links, lambda webhook payload) all
 ...
 * @returns {string} "#"-prefixed order number, or "" for falsy input
 */
